...
@section('content')
    ...
    <!-- KERANJANG -->
    <div class="container">
    <form action="" method="POST" class="form-group bg p-5 mt-5 mb-3 rounded">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
          ...
          <select name="#" id="activities" class="form-control">
              ...
              <option value="{{ $Kategoris->id }}" {{ old('kategori')==$Kategoris->id ?'selected':"" }}>{{ $Kategoris->deskripsi }}</option>
              @endforeach
